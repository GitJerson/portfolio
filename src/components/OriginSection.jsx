        ...
        <section className="port-section reveal-animate" id="origin">
            ...
            <div className="origin-content">
                <div className="origin-quote">
                    ...
                    .asp net projects following feature-based design for frontend architecture and using Repository-
                    Service-based pattern for my backend architecture. Right now, I've been learning Go which have been bumpy but fun. As of
                    April 5 2026, I've deployed at least 1 application for school project.
                </div>
